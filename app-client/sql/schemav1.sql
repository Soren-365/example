...
CREATE TABLE IF NOT EXISTS "record_table" (
    ...
    "createdAt" TIMESTAMP  DEFAULT now() NOT NULL,
    CONSTRAINT "pk_record_table" PRIMARY KEY (
        "id"
     )
);
...
ALTER TABLE "module_section_type" ADD CONSTRAINT "fk_module_section_type_record_table" FOREIGN KEY("record_table")
REFERENCES "record_table" ("id");

ALTER TABLE "record_section_type" ADD CONSTRAINT "fk_record_section_type_record_table" FOREIGN KEY("record_table")
REFERENCES "record_table" ("id");

ALTER TABLE "record_data" ADD CONSTRAINT "fk_record_data_record_table" FOREIGN KEY("record_table")
REFERENCES "record_table" ("id");
...
ALTER TABLE "page_record" ADD CONSTRAINT "fk_page_record_record_table" FOREIGN KEY("record_table")
REFERENCES "record_table" ("id");
...
ALTER TABLE "module_section" ADD CONSTRAINT "fk_module_section_record_table" FOREIGN KEY("record_table")
REFERENCES "record_table" ("id");
...
ALTER TABLE "record_filter" ADD CONSTRAINT "fk_record_filter_record_table" FOREIGN KEY("record_table")
REFERENCES "record_table" ("id");

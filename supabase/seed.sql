...
-- docker exec -it b9db5f77bd69 /bin/bash
-- docker exec -it b9db5f77bd69 psql -U postgres -d postgres
...
-- docker cp "/home/sg/Desktop/MEGAsync/dev/upwork/Adriel/conferati testdata/7th august/record_section_whitefilter_st.csv" supabase_db_frontend:/var/lib/postgresql/data/record_section_whitefilter_st.csv
-- docker cp "/home/sg/Desktop/MEGAsync/dev/upwork/Adriel/conferati testdata/7th august/record_section_blackfilter_st.csv" supabase_db_frontend:/var/lib/postgresql/data/record_section_blackfilter_st.csv

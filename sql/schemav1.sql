...
CREATE TABLE "module_section_type" (
    "id" bigint GENERATED ALWAYS AS IDENTITY,
    "name" text   NOT NULL,
...
CREATE TABLE "record_section_type" (
    "id" bigint GENERATED ALWAYS AS IDENTITY,
    "name" text   NOT NULL,
    "renderfunction" text   NOT NULL,
    "record_type" bigint NOT NULL,
...
CREATE TABLE "page_record_record" (
...
CREATE TABLE "page_module_section" (
    "id" bigint GENERATED ALWAYS AS IDENTITY,
    "title" text   NOT NULL,
    ...
    "record_filter" bigint NOT NULL,
    "record_data" bigint NOT NULL,
    "vertical_page_position" int   NOT NULL,
    "createdAt" TIMESTAMP  DEFAULT now() NOT NULL,
    CONSTRAINT "uc_page_module_section_vertical_page_position" PRIMARY KEY (
        "vertical_page_position"
    )
);

CREATE TABLE "page_record_section" (
    "id" bigint GENERATED ALWAYS AS IDENTITY,
    "title" text   NOT NULL,
    "record_section_type" bigint NOT NULL,
    "page_record" bigint NOT NULL,
    "sectiondata" jsonb   NULL,
    "vertical_page_position" int NOT NULL,
    "createdAt" TIMESTAMP  DEFAULT now() NOT NULL,
    CONSTRAINT "pk_page_record_section" PRIMARY KEY (
        "id"
     ),
    CONSTRAINT "uc_page_record_section_vertical_page_position" UNIQUE (
        "vertical_page_position"
    )
);
...
ALTER TABLE "page_module_section" ADD CONSTRAINT "fk_page_module_section_module_section_type" FOREIGN KEY("module_section_type")
REFERENCES "module_section_type" ("id");

ALTER TABLE "page_module_section" ADD CONSTRAINT "fk_page_module_section_page_module" FOREIGN KEY("page_module")
REFERENCES "page_module" ("id");

ALTER TABLE "page_module_section" ADD CONSTRAINT "fk_page_module_section_record_type" FOREIGN KEY("record_type")
REFERENCES "record_type" ("id");

ALTER TABLE "page_module_section" ADD CONSTRAINT "fk_page_module_section_record_filter" FOREIGN KEY("record_filter")
REFERENCES "record_filter" ("id");

ALTER TABLE "page_module_section" ADD CONSTRAINT "fk_page_module_section_record_data" FOREIGN KEY("record_data")
REFERENCES "record_data" ("id");

ALTER TABLE "page_record_section" ADD CONSTRAINT "fk_page_record_section_record_section_type" FOREIGN KEY("record_section_type")
REFERENCES "record_section_type" ("id");

ALTER TABLE "page_record_section" ADD CONSTRAINT "fk_page_record_section_page_record" FOREIGN KEY("page_record")
REFERENCES "page_record" ("id");
